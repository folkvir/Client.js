...
function createRequest(settings) {
  ...
  request.onerror = function () {
    requestProxy.emit('error', new Error('Error requesting ' + settings.url, request), request);
  };
  request.ontimeout = function () {
    requestProxy.emit('error', new Error('Timeout requesting ' + settings.url, request), request);
  };
