...
HttpClient.prototype._startRequest = function (request) {
  ...
  httpRequest.on('response', function (httpResponse) {
    ...
    self._computeStatistics(responseTime);
  });
...
HttpClient.prototype._computeStatistics = function (responseTime) {
  this._statistics.events.emit('newResponse', responseTime);
